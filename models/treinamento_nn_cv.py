...
def salvar_artifacts(modelo, features, melhor_nome_exp, melhor_f1, tabela_metricas):
    ...
    model_path = os.path.join(artifacts_dir, 'nn_best_cv.joblib')
    meta_path = os.path.join(artifacts_dir, 'nn_best_cv_meta.json')
    metrics_path = os.path.join(artifacts_dir, 'nn_cv_metricas_por_fold.csv')
